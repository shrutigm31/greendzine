...
export default function Dashboard() {
  ...
  const location = useLocation(); // To detect active route for sidebar highlighting
    ...
    <>
      ...
      <div className="dashboard">
        ...
        <aside className="sidebar-box">
          ...
          <div className={`nav-box ${location.pathname === "/" ? "active" : ""}`}>
            <FiGrid /> Dashboard
          </div>
          <div className="nav-box"><FiFolder /> Tables</div>
          <div className="account-title">ACCOUNT PAGES</div>
          <div className={`nav-box ${location.pathname === "/signin" ? "active" : ""}`}>
            <Link
              to="/signin"
          ...
          <div className={`nav-box ${location.pathname === "/signup" ? "active" : ""}`}>
            <Link
              to="/signup"
              style={{ color: "inherit", textDecoration: "none", display: "flex", alignItems: "center", gap: "4px" }}
            >
            ...
            <div className="profile-box">
              <div className="profile-left">
                <div className="avatar-wrapper">
                  ...
                  <div className="edit-icon"><FiEdit /></div>
                </div>
                <div>
                  <strong style={{ fontSize: 11 }}>Mark Johnson</strong>
                  <div style={{ fontSize: 8, opacity: 0.6 }}>mark@simmmple.com</div>
                </div>
              </div>
            ...
            <div className="info-grid">
              ...
              <div className="moptro-info-box">
                <div>
                  ...
                  <div style={{ fontSize: 7, opacity: 0.6, marginBottom: 4 }}>
              ...
              <div className="utilization-box" style={{ padding: "6px" }}>
                ...
                <small style={{ display: "block", marginBottom: 4, fontSize: 7 }}>
                  <span style={{ color: "#2be2b5" }}>+23%</span> than last week
                </small>

                <div style={{ display: "flex", justifyContent: "space-between", marginTop: 4, fontSize: 8 }}>
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 1 }}>
                    <FiBattery size={12} />
                    <span style={{ fontWeight: "bold" }}>$32,984</span>
                    <small>Wallet</small>
                  </div>
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 1 }}>
                    <FiTruck size={12} />
                    <span style={{ fontWeight: "bold" }}>35 Km</span>
                    <small>Range</small>
                  </div>
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 1 }}>
                    <FiZap size={12} />
                    <span style={{ fontWeight: "bold" }}>$2,400</span>
            ...
            <div className="bottom-grid">
              ...
              <div className="platform-box">
                ...
                <div className="setting-row">
                  ...
                  <div className={`toggle ${toggles.follow ? "" : "off"}`} onClick={() => toggleSwitch("follow")} />
                </div>
                <div className="setting-row">
                  Email me when someone answers me
                  <div className={`toggle ${toggles.answer ? "" : "off"}`} onClick={() => toggleSwitch("answer")} />
                </div>
                <div className="setting-row">
                  Email me when someone mentions me
                  <div className={`toggle ${toggles.mention ? "" : "off"}`} onClick={() => toggleSwitch("mention")} />
                </div>

                <div style={{ fontSize: 7, opacity: 0.5, marginTop: 4 }}>APPLICATION</div>
                <div className="setting-row">
                  New launches
                  <div className={`toggle ${toggles.newLaunches ? "" : "off"}`} onClick={() => toggleSwitch("newLaunches")} />
                </div>
                <div className="setting-row">
                  Monthly product updates
                  <div className={`toggle ${toggles.monthlyUpdates ? "" : "off"}`} onClick={() => toggleSwitch("monthlyUpdates")} />
                </div>
                <div className="setting-row">
                  Subscribe to newsletter
                  <div className={`toggle ${toggles.newsletter ? "" : "off"}`} onClick={() => toggleSwitch("newsletter")} />
                </div>
                <div className="setting-row">
                  Receive mails weekly
                  <div className={`toggle ${toggles.weeklyMails ? "" : "off"}`} onClick={() => toggleSwitch("weeklyMails")} />
                </div>
              </div>
              ...
              <div className="products-box">
                ...
                <div style={{ fontSize: 6, opacity: 0.6 }}>
